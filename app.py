...
# Define class labels
labels = ['Organik', 'Non Organik / Recycle']
...
def predict():
    ...
    if selected_model == 'cnn':
        ...
        img = image.load_img(file_path, target_size=(299, 128))
    ...
    if preprocessing_number == 0: 
        ...
        predicted_labels = [1 if pred > 0.5 else 0 for pred in prediction]

        # Map predicted labels to class names
        predicted_class = labels[predicted_labels[0]]
